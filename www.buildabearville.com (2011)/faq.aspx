...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUKLTE5MjE1MjcyM2RkO3cXpGErPZPlI9SSADB3/KYanT0=" />
		...
		so.addVariable('contactLink','mailto:vwhelp@buildabear.com');
       	so.addVariable('country','US');
            ...
            so.addVariable('bgImage','bgd_ForestBarn.jpg');
            so.write('branding');
        // ]]>
        </script> 
    ...
    <div id="mainContent" class="mainContent cc_tallest">
        ...
        <div id="faq" class="features btmFeatures">
            ...
            <div class="content">   
                ...
                <p>Signing up is free and there are no membership fees to play. Unlock cool places and games by purchasing an animal in our store.  Guests must register their furry friends at Name Me to receive an Animal ID and Key Code on their animal's birth certificate.</p>
