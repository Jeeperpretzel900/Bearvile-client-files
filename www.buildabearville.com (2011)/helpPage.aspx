    ...
    <div id="mainContent" class="mainContent cc_tallest">
        ...
        <div id="help" class="features btmFeatures">
            ...
            <div class="content">
                ...
                <a id="welcome"></a>
                <h3>Welcome</h3>
                <p>Hello and welcome to Build-A-Bearville – a Build-A-Bear Workshop&reg; world stuffed with fun where you can bring your furry friends to life online to play together! Click on the arrows and paw prints to explore the world. If you're having trouble and need a helping paw, click on the Help button.</p>

                <a id="explore"></a>
                <h3>Explore</h3>
                <p>Explore Build-A-Bearville – a Build-A-Bear Workshop&reg; world stuffed with fun! You can create your own character, earn points to buy cool virtual stuff, play and chat together, bring your furry friends to life, and play games and quests! If you're having trouble and need a helping paw, click on the Help button.</p>
                ...
                <a id="stuff"></a>
                <h3>My Stuff</h3>
                <p>This is the My Stuff screen, where you can keep track of all your stuff! Click on the icons above to see different categories of stuff – clothes, accessories, Cub Condo&reg; décor, furry friends and more! You can click on the button located inside the picture of each item to make your My Stuff visible or invisible to other characters. The more points you earn the more stuff you can buy!</p>
                ...
                <p>Simply click the Chat button and select a message.</p>

                <a id="find"></a>
                <h3>Find Your Way</h3>
                <p>There are lots of different areas to explore, such as the Libeary&reg;, the Town Square, the Pawforming Arts Center, the Sportsplex and more! Use this map to help you find your way.</p>

                <a id="store"></a>
                <h3>Virtual Build-A-Bear Workshop&reg; Store</h3>
                <p>Welcome to the virtual Build-A-Bear Workshop&reg; store where you can bring your furry friends to life. Go to the Take Me Home station and chat with the virtual Bear Builder&trade; associate. When you enter your animal ID and key code from the birth certificate you made for your furry friend in a Build-A-Bear Workshop store after October 2007, you will see your furry friend's name and birth date! Or enter the animal Web code printed on your Welcome Pass and select your furry friend from the on-screen menu.</p>
                ...
                <a id="shopping"></a>
                <h3>Shopping</h3>
                <p>There are different places in Build-A-Bearville where you can buy virtual clothing and accessories for your online character, plus Pawsome Den Décor for your Cub Condo&reg; house. Soon you will be able to buy outfits and accessories for your virtual furry friends, too.</p>
                ...
                <a id="neighborhood"></a>
                <h3>Neighborhood</h3>
                <p>You have just entered the Cub Condo&reg; complex. You have your own Cub Condo house where you and your furry friends all live together. You can color the outside, and each furry friend has their own room inside for you to customize.</p>
