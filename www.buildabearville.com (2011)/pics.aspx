...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
		...
		so.addVariable('contactLink','mailto:vwhelp@buildabear.com');
       	so.addVariable('country','US');
            ...
            so.addVariable('bgImage','bgd_Neighborhood.jpg');
            so.write('branding');
        // ]]>
        </script> 
                ...
                <div id="pics" class="features btmFeatures">
                    ...
                    <div class="content">
                        ...
                        <div class="virtualpage">
                            <div id="previewWin"><img src='landing_upload/maxine3_LG.jpg' alt='Furbulous Fashion District '/></div>
                            ...
                            <div id="wideInfo">
                                    ...
                                    <p>Maxine, Chief Executive Bear, made a beary special appearance to Build-A-Bearville to cele-bear-ate her birthday! 
                        ...
                        <div class="virtualpage">
                            <div id="previewWin"><img src='landing_upload/Coffee Shopf70.jpg' alt='Furbulous Fashion District '/></div>
                            <div id="game_navigation">
                            <div id='paginatediv1'>
                                <a href="#" rel="previous"><img src="images/games/btn_previous.gif" width="124" height="22" alt="Previous Game" /></a><a href="#" rel="next"><img src="images/games/btn_next.gif" width="124" height="22" alt="Next Game" /></a>
                            </div>
                            ...
                            <div id="wideInfo">
                                    <h3>Furbulous Fashion District </h3>
                                    <p>Some pawsome citizens who share furbulous style helped out at the Coffee Shop.</p>         
                                    <br /><br /><br />                                                      
                            </div>                     
                        </div>
            
                        <div class="virtualpage">
                            <div id="previewWin"><img src='landing_upload/BeeStylin_LG.jpg' alt='Furbulous Fashion District '/></div>
                            <div id="game_navigation">
                            <div id='paginatediv2'>
                                <a href="#" rel="previous"><img src="images/games/btn_previous.gif" width="124" height="22" alt="Previous Game" /></a><a href="#" rel="next"><img src="images/games/btn_next.gif" width="124" height="22" alt="Next Game" /></a>
                            </div>
                            ...
                            <div id="wideInfo">
                                    <h3>Furbulous Fashion District </h3>
                                    <p>Bee a trendsetter! Change your do at the Bee Stylin’ Salon.</p>         
                                    <br /><br /><br />                                                      
                            </div>                     
                        </div>
