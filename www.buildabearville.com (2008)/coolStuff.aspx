...
<head id="ctl00_Head1"><title>
	Build-A-Bearville - Beary Cool Stuff
...
<body>
    ...
    <div id="topspace"></div>
    <div id="container">
        <form name="aspnetForm" method="post" action="coolStuff.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
		...
		so.addVariable('contactLink','mailto:vwhelp@buildabear.com');
       	so.addVariable('country','US');
            ...
            so.addVariable('bgImage','bgd_ConcertHall.jpg');
            so.write('branding');
        // ]]>
        </script> 
        ...
        <div id="content" class="clear_children">
			...
			<div id="subContent" class="subContent">
				...
				<div id="picsSmall" class="features btmFeatures">
		                <a href="pics.aspx"><img src="images/home/pics.gif" width="201" height="244" alt="Pawsome Pics" /></a>
	 		    </div>
                <script type="text/javascript">
                // <![CDATA[
                    var so = new SWFObject('swf/gallery.swf', 'website', '200', '250', '9');
                    so.useExpressInstall('swfobject/expressinstall.swf');
                    so.addParam('allowScriptAccess', 'always');
                    so.addParam('wmode','transparent');
    ...
    <div id="mainContent" class="mainContent cc_tallest">
				...
				<div id="subNav" class="features">
						<ul>
							...
							<li><a href="coolStuff.aspx" class='selected'>Feature</a></li>   
					</ul>
				</div>

    
        
                <div id="coolStuff" class="features btmFeatures">
                    <div id="coolStuff_header">
                        <h2>Beary Cool Stuff</h2>
                        <img src="images/coolStuff/coolStuff_header-trans.png" width="171" height="24" alt="Pawsome Pics" />
                    </div>
                    <img src="images/global/module_top-trans.png" width="539" height="37" alt="" class="module_top" />
                    <div class="content">
            
                        <div class="virtualpage">
                            <div id="previewWin"><img src='landing_upload/Holiday Condo7a8.jpg' alt='Cub Condo house'/></div>
                            ...
                            <div id="wideInfo">
                                    <h3>Cub Condo house</h3>
                                    <p>Check out JenniferLoveable's furbulous selection of furniture!</p>         
                                    <br /><br /><br />                                                      
                            </div>                     
                        </div>
            
                        <div class="virtualpage">
                            <div id="previewWin"><img src='landing_upload/Cool CLothes432.jpg' alt='Cool character '/></div>
                            <div id="game_navigation">
                            <div id='paginatediv1'>
                                <a href="#" rel="previous"><img src="images/games/btn_previous.gif" width="124" height="22" alt="Previous Game" /></a><a href="#" rel="next"><img src="images/games/btn_next.gif" width="124" height="22" alt="Next Game" /></a>
                            </div>
                            ...
                            <div id="wideInfo">
                                    <h3>Cool character </h3>
                                    <p>BabyCub32 has furbulous style!</p>         
                                    <br /><br /><br />                                                      
                            </div>                     
                        </div>
            
                        <div class="virtualpage">
                            <div id="previewWin"><img src='landing_upload/hearts Puppyf2f.jpg' alt='Pawforming Arts Center'/></div>
                            <div id="game_navigation">
                            <div id='paginatediv2'>
                                <a href="#" rel="previous"><img src="images/games/btn_previous.gif" width="124" height="22" alt="Previous Game" /></a><a href="#" rel="next"><img src="images/games/btn_next.gif" width="124" height="22" alt="Next Game" /></a>
                            </div>
                            ...
                            <div id="wideInfo">
                                    ...
                                    <p>Hearts Fur You Puppy loves to dance in the Shake Your Honey game. </p>         
                                    <br /><br /><br />                                                      
                            </div>                     
                        </div>
            
                        <div class="virtualpage">
                            <div id="previewWin"><img src='landing_upload/Winter Park570.jpg' alt='Paw Park'/></div>
                            <div id="game_navigation">
                            <div id='paginatediv3'>
                                <a href="#" rel="previous"><img src="images/games/btn_previous.gif" width="124" height="22" alt="Previous Game" /></a><a href="#" rel="next"><img src="images/games/btn_next.gif" width="124" height="22" alt="Next Game" /></a>
                            </div>
                            ...
                            <div id="wideInfo">
                                    <h3>Paw Park</h3>
                                    <p>Bundle up! It's beary cold in Build-A-Bearville.</p>         
                                    <br /><br /><br />                                                      
                            </div>                     
                        </div>
            
                        <div class="virtualpage">
                            <div id="previewWin"><img src='landing_upload/Snowman 11ac.jpg' alt='Build A Snowman'/></div>
                            <div id="game_navigation">
                            <div id='paginatediv4'>
                                <a href="#" rel="previous"><img src="images/games/btn_previous.gif" width="124" height="22" alt="Previous Game" /></a><a href="#" rel="next"><img src="images/games/btn_next.gif" width="124" height="22" alt="Next Game" /></a>
                            </div>
                            ...
                            <div id="wideInfo">
                                    ...
                                    <p>This pawsome snowman has style from head to snow!</p>         
                                    <br /><br /><br />                                                      
                            </div>                     
                        </div>
            
                        <div class="virtualpage">
                            <div id="previewWin"><img src='landing_upload/Santa Hat.jpg' alt='My Stuff'/></div>
                            <div id="game_navigation">
                            <div id='paginatediv5'>
                                <a href="#" rel="previous"><img src="images/games/btn_previous.gif" width="124" height="22" alt="Previous Game" /></a><a href="#" rel="next"><img src="images/games/btn_next.gif" width="124" height="22" alt="Next Game" /></a>
                            </div>
                            ...
                            <div id="wideInfo">
                                    <h3>My Stuff</h3>
                                    <p>Ho! Ho! Ho! HaileyGirl2 bundled up for the snow.</p>         
                                    <br /><br /><br />                                                      
                            </div>                     
                        </div>
